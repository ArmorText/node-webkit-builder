...
module.exports = {
    ...
    getVersion: function(args){
        return (isLegacyVersion(args.desiredVersion) ? getLegacyVersions : getVersionsFromManifest)(args.downloadUrl, args.flavor)
            .then(function(versions){
                ...
                throw new Error('Version ' + args.desiredVersion + ' (' + args.flavor + ') not found.');
            });
    },
    /**
     * @param {string} downloadUrl
