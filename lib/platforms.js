...
module.exports = {
    win32: {
        ...
        files: { // First file must be the executable
            ...
            '>=0.13.0 <0.14.1': ['nw.exe', 'nw.dll', 'nw_elf.dll', 'node.dll', 'ffmpeg.dll', 'dbghelp.dll', 'icudtl.dat', 'libEGL.dll', 'libGLESv2.dll', 'nw_100_percent.pak', 'nw_200_percent.pak', 'resources.pak', 'locales', 'd3dcompiler_47.dll', 'natives_blob.bin', 'snapshot_blob.bin', 'credits.html'],
            '>=0.14.1 <0.15.0': ['nw.exe', 'nw.dll', 'nw_elf.dll', 'node.dll', 'ffmpeg.dll', 'libexif.dll', 'dbghelp.dll', 'icudtl.dat', 'libEGL.dll', 'libGLESv2.dll', 'nw_100_percent.pak', 'nw_200_percent.pak', 'resources.pak', 'locales', 'd3dcompiler_47.dll', 'natives_blob.bin', 'snapshot_blob.bin', 'credits.html'],
            '>=0.15.0': ['nw.exe', 'nw.dll', 'nw_elf.dll', 'node.dll', 'ffmpeg.dll', 'icudtl.dat', 'libEGL.dll', 'libGLESv2.dll', 'nw_100_percent.pak', 'nw_200_percent.pak', 'nw_material_100_percent.pak', 'nw_material_200_percent.pak', 'resources.pak', 'locales', 'd3dcompiler_47.dll', 'natives_blob.bin', 'snapshot_blob.bin', 'credits.html']
        },
